...
def segment_images(input_raw_ds_path, output_segmented_ds_dir, model_path,
    ...
    image_paths = glob.glob(os.path.join(input_raw_ds_path, '*.jpg'))  # Adjust extension if needed
    ...
    for image_path in tqdm(image_paths, desc="Segmenting images"):
        ...
        output_image_path = os.path.join(final_output_dir, f"{post_id}_{image_num}_segmented.jpg")
...
if __name__ == '__main__':
    input_directory = '/Users/albert.bikeev/Projects/sobaken-id/re-identification/data/raw_clean_dom_lapkin_2'
    output_directory = '/Users/albert.bikeev/Projects/sobaken-id/re-identification/data/segmented_dom_lapkin_2__FLAT_AREA'
    model_file = '/Users/albert.bikeev/Projects/sobaken-id/trained_models/segm_PixelLib_pointrend_resnet50.pkl'

    segment_images(input_directory, output_directory, model_file,
